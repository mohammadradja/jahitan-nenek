        ...
        <div class="fixed inset-0 z-[200000] flex items-center justify-center p-6 overflow-y-auto">
            ...
            <div class="relative bg-white w-full max-w-5xl rounded-[3rem] shadow-2xl p-10 animate__animated animate__zoomIn animate__faster my-auto overflow-y-auto max-h-[90vh]">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button @click="showCreateModal = false" class="text-gray-400 hover:text-dark-wool transition-colors">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-5 flex flex-col h-full">
                            <div class="flex-1">
                                ...
                                <textarea name="content" required class="input-premium py-3 px-5 text-xs h-[138px] resize-none leading-relaxed" placeholder="Ceritakan kehangatan di balik rajutan ini..."></textarea>
                            </div>
                            <div class="flex-1">
                                <label class="block text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Konten Artikel (EN)</label>
                                <textarea name="content_en" required class="input-premium py-3 px-5 text-xs h-[138px] resize-none leading-relaxed" placeholder="Tell the story of this knit in English..."></textarea>
                            </div>
                        </div>
                    </div>
