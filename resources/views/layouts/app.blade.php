        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-20">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
                <div>
                    ...
                    <p class="leading-relaxed">{{ __('messages.footer_desc') }}</p>
                </div>
                <div class="md:text-center">
                    <h5 class="text-xl font-bold text-white mb-6 font-serif">{{ __('messages.contact_us') }}</h5>
                    <div class="space-y-4">
                        ...
                        <a href="{{ route('order.track') }}" class="inline-flex items-center mt-4 text-white hover:text-soft-rose transition-colors underline decoration-soft-rose decoration-2 underline-offset-8">
                            <i class="fas fa-search-location mr-2"></i> {{ __('messages.track_order') }}
                        </a>
                    </div>
                </div>
            ...
            <div class="flex flex-col space-y-6 text-center">
                ...
                @guest
                    <div class="pt-6 flex flex-col space-y-4">
                        <a href="{{ route('login') }}" class="text-lg font-bold text-dark-wool">{{ __('messages.login') }}</a>
                        <a href="{{ route('register') }}" class="btn-premium py-4 text-sm uppercase tracking-widest">{{ __('messages.register') }}</a>
                    </div>
                @endguest
